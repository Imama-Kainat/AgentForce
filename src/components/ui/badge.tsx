  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        neon: "border-transparent bg-neon text-neon-foreground hover:bg-neon/80 hover:scale-105 shadow-glow-neon",
        success: "border-transparent bg-success text-success-foreground hover:bg-success/80 hover:scale-105",
        glass: "glass-card text-white border-white/20 hover:bg-white/10 hover:scale-105",
      },
    },
    defaultVariants: {
      variant: "default",
