  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'glow-accent': '0 0 20px hsl(199 89% 48% / 0.5)',
        'glow-neon': '0 0 20px hsl(322 82% 59% / 0.5)',
        'inner-glow': 'inset 0 1px 0 hsl(255 255 255 / 0.1)',
      },
      keyframes: {
        "accordion-down": {
          from: {
        ...
        "pulse-glow": {
          ...
          "50%": {
            boxShadow: "0 0 40px hsl(262 83% 58% / 0.8)",
          },
        },
        "float": {
          "0%, 100%": {
